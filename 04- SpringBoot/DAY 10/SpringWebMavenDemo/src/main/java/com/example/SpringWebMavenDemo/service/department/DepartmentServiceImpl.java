...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    public Department updateDepartment(Department department, Long departmentId) {
        ...
        if (Objects.nonNull(department.getDepartmentEmailId()) && !Constants.BLANK_STRING.equalsIgnoreCase(department.getDepartmentEmailId())) {
            depDB.setDepartmentEmailId(department.getDepartmentEmailId());
        }
